<?php
/**
 * This class handles Podcast embed functionalities.
 */
...
class Podcast {
    ...
    public function __construct() {
        $this->opt_out_type = ConsentType::PREFERENCES;
        $this->hooks();
    }
    ...
    /**
     * Add placeholder markup for Podcast embeds.
    ...
    public function add_placeholder( $html, $url ) {
         ...
         * 'image' to show the video thumbnail and link to Podcast.
         *
         * @param $type The type of placeholder to use, see description.
         */
        $placeholder_type = \apply_filters( 'cookiebot_helper_podcast_placeholder_type', self::PLACEHOLDER_TYPE_RENEW );
        ...
        /**
         * Filter the Podcast embed placeholder HTML string.
         *
         * @param string $html The placeholder HTML string.
         */
        $placeholder = \apply_filters( 'cookiebot_helper_podcast_placeholder_output', $placeholder );
